      ...
      {!loading && letters.length === 0 && (
        ...
        >
          <img
            ...
            alt="no data"
          />
          <p className="text-gray-700 mt-4 text-lg font-medium">No letters found</p>
        </motion.div>
      )}
          ...
          >
            ...
            {letter.resumeText && (
              <details className="mt-3">
                <summary className="cursor-pointer text-blue-600 text-sm mb-2">View Resume</summary>
            ...
            {letter.jobDescription && (
              <details className="mt-3">
                <summary className="cursor-pointer text-blue-600 text-sm mb-2">View Job Description</summary>
            ...
            <div className="mt-4 bg-gray-50 p-3 rounded-md max-h-40 overflow-y-auto border border-gray-200">
              <p className="text-sm text-gray-700 whitespace-pre-wrap">{letter.content ?? ""}</p>
            </div>
