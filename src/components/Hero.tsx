...
export default function Hero() {
    return (
        <>
            <div className="relative overflow-hidden h-screen mx-auto md:mx-16">
                <div className="absolute inset-0 bg-blue-200/20 clip-diagonal z-0 rounded-2xl" />

                <div className="h-full flex justify-center items-center  relative">
                    <div className="mx-1 grid grid-cols-1 md:grid-cols-2 gap-20 bg-transparent p-4">
                        <div className="flex justify-start items-start font-semibold font-poppins flex-col space-y-2 text-2xl md:text-3xl lg:text-6xl">
                            <motion.div
                             className="space-y-2"
                             initial={{ opacity: 0 }}
                             animate={{ opacity: 1 }}
                        ...
                        <div className="flex justify-center">
                            <img src="/images/heroImg3.png" className="h-0 md:h-60 lg:h-130 w-200" alt="" />
                        </div>
                    </div>
                </div>
            </div>
