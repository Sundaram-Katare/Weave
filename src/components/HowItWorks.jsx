...
export default function HowItWorks() {
    return (
        <>
            <div className="flex flex-col m-16 justify-center items-center p-4 space-y-5">
                <h1 className="font-semibold font-poppins text-4xl">How to use it?</h1>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cumque repellat facilis.</p>
